...
export default function DataTable({ columns, data, onEdit, onDelete, onView, editLabel = 'Edit', deleteLabel = 'Delete', viewLabel = 'View', emptyMessage = 'No data found' }) {
                  ...
                  <div className="flex gap-2">
                    {onView && (
                      <button onClick={() => onView(row)}
                        className="inline-flex items-center gap-1.5 bg-gray-600/20 hover:bg-gray-600 text-gray-400 hover:text-white border border-gray-500/30 hover:border-gray-600 px-3 py-1.5 rounded-lg text-xs font-medium transition cursor-pointer whitespace-nowrap">
                    ...
                    <button onClick={() => onEdit(row)}
                      className="inline-flex items-center gap-1.5 bg-blue-600/20 hover:bg-blue-600 text-blue-400 hover:text-white border border-blue-500/30 hover:border-blue-600 px-3 py-1.5 rounded-lg text-xs font-medium transition cursor-pointer whitespace-nowrap">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <button onClick={() => onDelete(row)}
                      className="inline-flex items-center gap-1.5 bg-red-600/20 hover:bg-red-600 text-red-400 hover:text-white border border-red-500/30 hover:border-red-600 px-3 py-1.5 rounded-lg text-xs font-medium transition cursor-pointer whitespace-nowrap">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" viewBox="0 0 20 20" fill="currentColor">
